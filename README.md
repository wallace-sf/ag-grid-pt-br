...
Tradução não oficial em português do Brasil. Para mais informações sobre tradução [clique aqui](https://www.ag-grid.com/react-data-grid/localisation/).

## Instalação
Para instalar um *locale* é necessário passar o objeto a seguir na propriedade `localeText`.
...
## Contribuições
Contribuições são bem-vindas. Sinta-se à vontade de abrir um *Pull Request* ou sugerir melhorias.
