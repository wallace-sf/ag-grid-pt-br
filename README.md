# AG Grid em Português Brasileiro

Tradução não oficial em português do Brasil. Para mais informações sobre tradução [clique aqui](https://www.ag-grid.com/javascript-data-grid/localisation/).

## Instalação

Para instalar um _locale_ é necessário passar o objeto a seguir na propriedade `localeText`.
...
Contribuições são bem-vindas. Sinta-se à vontade de abrir um _Pull Request_ ou sugerir melhorias.
